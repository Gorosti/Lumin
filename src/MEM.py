...
class MEM():
    ...
    def define_model(self, material, guess, sheet_name, model_idx, residual):
        ...
        if material == 'F':
            def function(data, i, e, *q):  # not all parameters are used here, r is shared
                ...
                if e == 2:
                    return r + (1 - r) * n_GOM2(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)]]))
                if e == 3:
                    return r + (1 - r) * n_GOM3(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)]]))
                if e == 4:
                    return r + (1 - r) * n_GOM4(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)]]))
                if e == 5:
                    return r + (1 - r) * n_GOM5(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)], q[self.IDX(e, i, 6)]]))
            ...
            def function_unp(data, i, e, *q):  # not all parameters are used here, r is shared
                ...
                if e == 2:
                    return r + (1 - r) * n_GOM2_unp(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)]]))
                if e == 3:
                    return r + (1 - r) * n_GOM3_unp(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)]]))
                if e == 4:
                    return r + (1 - r) * n_GOM4_unp(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)]]))
                if e == 5:
                    return r + (1 - r) * n_GOM5_unp(data, *np.array(
                        [q[0], q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)], q[self.IDX(e, i, 6)]]))
        ...
        if material == 'Q':
            def function(data, i, e, *q):  # not all parameters are used here, r is shared
                ...
                if e == 2:
                    return r + (1 - r) * n_FOM2(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)]]))
                if e == 3:
                    return r + (1 - r) * n_FOM3(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)]]))
                if e == 4:
                    return r + (1 - r) * n_FOM4(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)]]))
                if e == 5:
                    return r + (1 - r) * n_FOM5(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)], q[self.IDX(e, i, 6)]]))
            ...
            def function_unp(data, i, e, *q):  # not all parameters are used here, r is shared
                ...
                if e == 2:
                    return r + (1 - r) * n_FOM2_unp(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)]]))
                if e == 3:
                    return r + (1 - r) * n_FOM3_unp(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)]]))
                if e == 4:
                    return r + (1 - r) * n_FOM4_unp(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)]]))
                if e == 5:
                    return r + (1 - r) * n_FOM5_unp(data, *np.array(
                        [q[self.IDX(e, i, 1)], q[self.IDX(e, i, 2)], q[self.IDX(e, i, 3)], q[self.IDX(e, i, 4)],
                         q[self.IDX(e, i, 5)], q[self.IDX(e, i, 6)]]))
            ...
            if event >= 2:
                ...
                if event >= 3:
                    ...
                    if event == 3:  # exposure #2
                        idx_2 = np.argmin(
                            np.abs(yi / yi_prev2 - (1 - WBtolerance)))  # find index for burial1 > (1-x)% of exposure 2
                        x_wb2 = xi[idx_2]
                        x_wb3 = np.nan
                        x_wb4 = np.nan
                    if event >= 4:
                        yi_prev3 = self.fun_unp(xi, i, 3, *self.poptCI)  # exposure # 2
                        idx_2 = np.argmin(np.abs(
                            yi_prev3 / yi_prev2 - (1 - WBtolerance)))  # find index for burial1 > (1-x)% of exposure 2
                        x_wb2 = xi[idx_2]
                        if event == 4:  # burial #2
                            idx_3 = np.argmin(
                                np.abs(yi_prev3 / yi - WBtolerance))  # find index for exp2 < x% of burial 2
                            x_wb3 = xi[idx_3]
                            x_wb4 = np.nan
                        if event == 5:  # exposure #3
                            yi_prev4 = self.fun_unp(xi, i, 4, *self.poptCI)  # burial # 2
                            idx_3 = np.argmin(
                                np.abs(yi_prev3 / yi_prev4 - WBtolerance))  # find index for exp2 < x% of burial 2
                            x_wb3 = xi[idx_3]
                            idx_4 = np.argmin(np.abs(
                                yi / yi_prev4 - (1 - WBtolerance)))  # find index for burial2 > (1-x)% of exposure 3
                            x_wb4 = xi[idx_4]
            ...
            if len(know_Age_log) > 1:  # Only run ERC fit if more than one exp. is known
                ...
                for i in range(0, len(sheet_name)):  # different profiles
                    ...
                    for j in range(0, len(XP_all[0])):  # monte carlo runs
                        t_erc = [
                            ERC_solve(XP_all[i][j], *par_ERC_moteCarlo[j])]  # estimated exp. times from ERC
                        if np.isfinite(KNOWN_EXP_TIME1[i]):  # if the exposure time is known write nan
                            t_erc = [np.nan]
                ...
                for i in range(0, len(sheet_name)):  # different profiles
                    if np.isfinite(self.t_ERC[i]):
                        ...
                        ax1.hist(t_ERC_monteCarlo[i], bins=20, edgecolor='black',
                                 weights=np.ones_like(t_ERC_monteCarlo[i]) / len(t_ERC_monteCarlo[i]))
    ...
    def fitting_array(self, sheet_name, material, guess, logID, weight, model_idx, WBtolerance, PlotPredictionBands,
                      PlotPrev, Site_idx, Thickness, Known_exp_time1, Known_exp_time2, Known_exp_time3, residual):
